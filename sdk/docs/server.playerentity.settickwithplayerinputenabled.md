...
Use for: temporarily disabling player control (cutscenes, menus, stuns). When disabled, queued input is discarded, speculative block edits are rolled back, and active control state is cleared.
